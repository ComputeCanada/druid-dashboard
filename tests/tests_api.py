...
class TestPostingSuccessiveReports:
  ...
  def test_get_non_existent_burst(self, client):
  ...
  def test_post_bursts_updated(self, client, notifier):
  ...
  def test_post_bursts_with_updated_submitters(self, client, notifier):
    """
